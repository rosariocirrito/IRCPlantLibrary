...
public:
	Equip eq[2] = {
	  Equip("Eq1",0, 0, false, 1, 2, false, 2000L, 5000L, 0, 0, false, 1, false),
	  Equip("Eq2",0, 0, false, 3, 4, false, 2000L, 5000L, 0, 0, false, 2, false)
	};
	TwinSeq(String name, Equip eq[], unsigned long setIntTmr, bool bothStart, bool bothStop, bool start);
	void seq();
	void setTimerInterd(unsigned long tmr);
...
public:
	...
	//
	void seq();
	void setTimerInterd1(unsigned long tmr1);
	void setTimerInterd2(unsigned long tmr2);
	String toString();
